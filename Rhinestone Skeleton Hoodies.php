      ...
      <div class="product-details-container">
        <div class="product-left">
          <div class="product-details-img">
            <img class="product-image-detail" src="img/products/Top/women/jackets/Rhinestone Skeleton Hoodies/shiny-bones-overcloud.webp" alt="first-photo-dollar-jeans">
          </div>
        </div>
          <div class="product-right">
            ...
            <div class="product-size">
              ...
              <button onclick="buttonClicked(this)">XXL</button>
            </div>
            <div class="product-description-details-details">
              <p>Y2K Rhinestone Skeleton Hoodie Women Black Zip Up Female Retro Harajuku Jacket Hooded Streetwear.</p>
              <p>Ribs design made of rhinestones on the front of the hoddie.</p>
            </div>
        ...
        <div class="hover-container">
          <div>
            <img src="img/products/Top/women/jackets/Rhinestone Skeleton Hoodies/shiny-bones-overcloud.webp" alt="">
          </div>
          <div>
            <img src="img/products/Top/women/jackets/Rhinestone Skeleton Hoodies/zsbo1.webp" alt="">
          </div>
          <div>
            <img src="img/products/Top/women/jackets/Rhinestone Skeleton Hoodies/zsbo2.webp" alt="">
          </div>
          <div>
            <img src="img/products/Top/women/jackets/Rhinestone Skeleton Hoodies/zsbo3.webp" alt="">
          </div>
          <div>
            <img src="img/products/Top/women/jackets/Rhinestone Skeleton Hoodies/zsbo4.webp" alt="">
          </div>
        </div>
